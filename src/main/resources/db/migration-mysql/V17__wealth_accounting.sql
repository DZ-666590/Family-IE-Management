...
alter table investment_trades drop check ck_investment_trades_type;
alter table investment_trades drop check ck_investment_trades_action_shape;
...
alter table asset_valuations drop index uk_asset_valuations_asset_date_source;
