...
public final class InvestmentPlanDtos {
    ...
    public record Request(String name, Long accountId, Long securityId, String amount,
    ...
    public record Plan(long id, String name, long accountId, String accountName, long fundingAccountId,
            long securityId, String securityName, String symbol, String currency, String amount,
    ...
    public record Occurrence(long id, long planId, String planName, long accountId, String accountName,
            ...
            String amount, LocalDate dueOn, long assignedUserId, String state, Instant remindAt,
            Long tradeId, String actualAmount, String reason, Long actedBy, Instant actedAt,
