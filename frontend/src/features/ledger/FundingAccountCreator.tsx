...
export function FundingAccountCreator({currency,request,onCreated,onClose,presentation='drawer'}:{presentation?:'drawer'|'modal';currency:string;request:RequestFn;onCreated:(account:Account)=>void;onClose:()=>void}){
 ...
 return <Drawer presentation={presentation} open title={`新建 ${currency} 资金账户`} draft={{...draft,...kind}} busy={save.isPending} onClose={onClose}>
