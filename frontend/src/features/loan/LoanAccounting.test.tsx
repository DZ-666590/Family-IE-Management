...
function setup(userId = 7) {
  ...
  const request = vi.fn(async (path: string, opts?: any) => {
    ...
    if (path.includes('/schedule')) return page([{ id: 9, installmentNo: 1, dueOn: '2026-01-02', principal: '1000.00', interest: '100.00', cashAmount: '1100.00', status: 'PENDING', paidOn: null }]);
