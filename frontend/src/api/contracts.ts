...
export interface MarketPrice { securityId: number; tsCode: string; name: string; price: string | null; source: 'TUSHARE' | 'BAOSTOCK' | 'MANUAL' | null; tradeDate: string | null; fetchedAt: string | null; stale: boolean; error: string | null }
export interface PortfolioPosition { valuationStatus?: 'QUOTED' | 'COST_ESTIMATE' | 'CLOSED'; estimatedValue?: string; accountId: number; accountName: string; brokerName: string; securityId: number; tsCode: string; name: string; quantity: number; averageCost: string; cost: string; price: string | null; marketValue: string | null; realizedProfit: string; unrealizedProfit: string | null; totalProfit: string | null; allocationPercent: string | null; source: 'TUSHARE' | 'BAOSTOCK' | 'MANUAL' | null; tradeDate: string | null; fetchedAt: string | null; stale: boolean; error: string | null }
