alter table securities alter column ts_code varchar(64);
alter table securities alter column name varchar(200);
...
alter table securities drop constraint ck_securities_market;
alter table securities drop constraint ck_securities_ts_code;
