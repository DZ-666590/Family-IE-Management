...
export interface InvestmentAccount { cashAccountId?: number | null; id: number; name: string; brokerName: string; currency: string; status: 'ACTIVE' | 'ARCHIVED'; createdBy: number; archivedAt: string | null }
